...
NOTE: We will output our normals to whatever is bound to Color1
...
void main() {
	...
	NOTE: We need to map our normals from the [-1, 1] range into the [0,1] range, which is what this does
